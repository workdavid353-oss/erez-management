// Mock data — will be replaced by Supabase queries once local instance is set up
...
export const workerCols = mockUsers.filter(u => u.active && u.role !== 'secretary')

export const categories = ['אזרחי', 'פלילי', 'מסחרי', 'משפחה', 'נדל"ן', 'עבודה']
...
export const mockCases = [
  {
    ...
    status: 'בטיפול', tasks: { u1: 'progress', u3: 'urgent', u4: 'pending' },
  ...
  },
  {
    ...
    status: 'דחוף', tasks: { u1: 'urgent', u3: 'progress' },
  ...
  },
  {
    ...
    status: 'בטיפול', tasks: { u1: 'progress', u4: 'progress', u5: 'pending' },
  ...
  },
  {
    ...
    status: 'ממתין', tasks: { u3: 'blocked', u5: 'pending' },
  ...
  },
  {
    ...
    status: 'בטיפול', tasks: { u4: 'done', u5: 'progress' },
  ...
  },
  {
    ...
    status: 'בטיפול', tasks: { u1: 'progress', u4: 'progress' },
  ...
  },
  {
    ...
    status: 'הושלם', tasks: { u1: 'done', u3: 'done', u4: 'done' },
  ...
  },
  {
    ...
    status: 'דחוף', tasks: { u3: 'urgent', u4: 'urgent' },
  ...
  },
  {
    ...
    status: 'ממתין', tasks: { u3: 'pending', u5: 'blocked' },
  ...
  },
  {
    ...
    status: 'בטיפול', tasks: { u1: 'progress', u5: 'progress' },
  ...
  },
  {
    ...
    status: 'בטיפול', tasks: { u1: 'progress', u3: 'progress' },
